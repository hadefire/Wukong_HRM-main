...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'hrm员工操作记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `wk_hrm_employee`  (
  ...
  `job_number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `dept_id` bigint NULL DEFAULT NULL COMMENT '部门ID',
...
CREATE TABLE `wk_hrm_field_extend`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '扩展自定义字段表' ROW_FORMAT = DYNAMIC;
