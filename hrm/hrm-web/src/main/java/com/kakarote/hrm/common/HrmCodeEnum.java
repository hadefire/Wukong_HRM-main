...
public enum HrmCodeEnum implements ResultCode {
    ...
    RESULT_EMPLOYEE_NOT_EXIT(7016, "员工不存在"),
    RESULT_ROLE_NOT_EXIT(7017, "角色不存在或无效"),
    // 登录相关错误码
    LOGIN_USER_NOT_FOUND(7018, "用户不存在，请检查手机号是否正确"),
    LOGIN_PASSWORD_ERROR(7019, "密码错误，请重新输入"),
    LOGIN_USER_DISABLED(7020, "账号已被禁用或已离职"),
    LOGIN_OLD_PASSWORD_ERROR(7021, "旧密码错误"),
    // 角色管理相关错误码
    ROLE_NAME_EXISTS(7022, "角色名称已存在"),
    ROLE_NOT_FOUND(7023, "角色不存在"),
    ROLE_HAS_USERS(7024, "该角色已被用户使用，无法删除"),
    // 菜单管理相关错误码
    MENU_NAME_EXISTS(7025, "菜单名称已存在"),
    MENU_NOT_FOUND(7026, "菜单不存在"),
    MENU_HAS_CHILDREN(7027, "该菜单存在子菜单，无法删除"),
    MENU_HAS_ROLES(7028, "该菜单已被角色使用，无法删除");
