    ...
    <el-tabs v-model="activeName" class="main-tabs">
      <el-tab-pane label="功能简介" name="function" class="main-menu">
        ...
        <div class="main-menu-items">
          ...
          <div class="main-menu-items-content">
            Ever-HRMS系统中未储存的来电号码（比如新客户的来电咨询），销售人员可以把来电号码一键存储为线索信息，这可以很方便的衔接之后的销售和服务过程，而且当该客户再次来电时，CRM系统就能自动识别该客户。
          </div>
        ...
        <div class="main-menu-items">
          ...
          <div class="main-menu-items-content">
            对通话记录进行分析，考核销售团队的业绩、激励改进。Ever-HRMS的商业智能版块提供员工通话记录分析图表，可视化方式呈现您的通话记录数据，从中分析如何给客户提供更好的体验。
          </div>
          <img
